...
extern asn_TYPE_descriptor_t asn_DEF_presentation_data_values __attribute__((weak, alias("asn_DEF_presentation_data_values_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_presentation_data_values_4;
static asn_TYPE_descriptor_t asn_DEF_presentation_data_values;
__attribute__((constructor)) static void asn_DEF_presentation_data_values_4_alias_init(void) {
	asn_DEF_presentation_data_values = asn_DEF_presentation_data_values_4;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
#if !defined(ASN_DISABLE_JER_SUPPORT)
static asn_jer_constraints_t asn_JER_memb_arbitrary_constr_7 CC_NOTUSED = {
	-1,
	0,
	0};
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
static asn_TYPE_member_t asn_MBR_PDV_list__presentation_data_values_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_presentation_data_values_4 = {
	...
	asn_MBR_PDV_list__presentation_data_values_4,
	3,	/* Elements count */
