...
class CP_type(_Asn1Type):  # SET
    class normal_mode_parameters_TYPE(_Asn1Type):  # SEQUENCE
        ...
        def protocol_version(
            self, value: Protocol_version | EXT_bitarray | int | bytes | None
        ) -> None: ...
        ...
        presentation_context_definition_list: (
            Presentation_context_definition_list | None
        )
        ...
        def presentation_requirements(
            self, value: Presentation_requirements | EXT_bitarray | int | bytes | None
        ) -> None: ...
        @property
        def user_session_requirements(self) -> User_session_requirements | None: ...
        @user_session_requirements.setter
        def user_session_requirements(
            self, value: User_session_requirements | EXT_bitarray | int | bytes | None
        ) -> None: ...
        @property
        def protocol_options(self) -> Protocol_options | None: ...
        @protocol_options.setter
        def protocol_options(
            self, value: Protocol_options | EXT_bitarray | int | bytes | None
        ) -> None: ...
        @property
        def initiators_nominated_context(
            self,
        ) -> Presentation_context_identifier | None: ...
        @initiators_nominated_context.setter
        def initiators_nominated_context(
            self, value: Presentation_context_identifier | int | None
        ) -> None: ...
    ...
    mode_selector: Mode_selector | None
    def __init__(
        self,
        /,
        *,
...
class CPA_PPDU(_Asn1Type):  # SET
    class normal_mode_parameters_TYPE(_Asn1Type):  # SEQUENCE
        ...
        @property
        def responders_nominated_context(
            self,
        ) -> Presentation_context_identifier | None: ...
...
class ARU_PPDU(_Asn1Type):  # CHOICE
    ...
    class normal_mode_parameters_TYPE(_Asn1Type):  # SEQUENCE
        @property
        def presentation_context_identifier_list(
            self,
        ) -> Presentation_context_identifier_list | None: ...
        @presentation_context_identifier_list.setter
        def presentation_context_identifier_list(
            self, value: Presentation_context_identifier_list | list | None
        ) -> None: ...
        user_data: User_data | None
        def __init__(
            self,
...
class AC_PPDU(_Asn1Type):  # SEQUENCE
    ...
    @property
    def presentation_context_deletion_list(
        self,
    ) -> Presentation_context_deletion_list | None: ...
    @presentation_context_deletion_list.setter
    def presentation_context_deletion_list(
        self, value: Presentation_context_deletion_list | list | None
    ) -> None: ...
    user_data: User_data | None
    def __init__(
        self,
...
class ACA_PPDU(_Asn1Type):  # SEQUENCE
    presentation_context_addition_result_list: (
        Presentation_context_addition_result_list | None
    )
    @property
    def presentation_context_deletion_result_list(
        self,
    ) -> Presentation_context_deletion_result_list | None: ...
    @presentation_context_deletion_result_list.setter
    def presentation_context_deletion_result_list(
        self, value: Presentation_context_deletion_result_list | list | None
    ) -> None: ...
    user_data: User_data | None
    def __init__(
        self,
...
class Context_list(_Asn1Type):
    class Member_TYPE(_Asn1Type):  # SEQUENCE
        class transfer_syntax_name_list_TYPE(_Asn1Type):
            def __init__(
                self, values: EXT_Iterable[Transfer_syntax_name] | None = ...
            ) -> None: ...
        ...
        @property
        def presentation_context_identifier(
            self,
        ) -> Presentation_context_identifier: ...
        @presentation_context_identifier.setter
        def presentation_context_identifier(
            self, value: Presentation_context_identifier | int
        ) -> None: ...
        @property
...
class Presentation_context_deletion_list(_Asn1Type):
    def __init__(
        self, values: EXT_Iterable[Presentation_context_identifier] | None = ...
    ) -> None: ...
    def __getitem__(self, index: int) -> Presentation_context_identifier: ...
    def __setitem__(
        self, index: int, value: Presentation_context_identifier
    ) -> None: ...
...
class Result_list(_Asn1Type):
    class Member_TYPE(_Asn1Type):  # SEQUENCE
        ...
        def transfer_syntax_name(
            self, value: Transfer_syntax_name | str | None
        ) -> None: ...
...
class User_data(_Asn1Type):  # CHOICE
    ...
    def simply_encoded_data(
        self, value: Simply_encoded_data | bytes | None
    ) -> None: ...
    @property
