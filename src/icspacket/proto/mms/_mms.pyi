from collections.abc import Iterable as EXT_Iterable
...
from typing_extensions import Self as EXT_Self
...
class _Asn1Type:
    ...
    @classmethod
    def ber_decode(cls: type[EXT_Self], data: bytes) -> EXT_Self: ...
    def cer_encode(self) -> bytes: ...
    @classmethod
    def cer_decode(cls: type[EXT_Self], data: bytes) -> EXT_Self: ...
    def der_encode(self) -> bytes: ...
    @classmethod
    def der_decode(cls: type[EXT_Self], data: bytes) -> EXT_Self: ...
    def xer_encode(self, /, *, canonical: bool = ...) -> bytes: ...
    @classmethod
    def xer_decode(
        cls: type[EXT_Self], data: bytes, /, *, canonical: bool = ...
    ) -> EXT_Self: ...
    def jer_encode(self, /, *, minified: bool = ...) -> bytes: ...
    @classmethod
    def jer_decode(
        cls: type[EXT_Self], data: bytes, /, *, minified: bool = ...
    ) -> EXT_Self: ...
    def to_text(self) -> bytes: ...

@EXT_type_check_only
class _Asn1BasicType(_Asn1Type, EXT_Generic[_PY_T]):
...
class RDNSequence(_Asn1Type):
    def __init__(
        self, values: EXT_Iterable[RelativeDistinguishedName] | None = ...
    ) -> None: ...
...
class RelativeDistinguishedName(_Asn1Type):
    def __init__(
        self, values: EXT_Iterable[AttributeTypeAndValue] | None = ...
    ) -> None: ...
...
class AARQ_apdu(_Asn1Type):  # SEQUENCE
    ...
    def protocol_version(
        self, value: protocol_version_TYPE | EXT_bitarray | bytes | None
    ) -> None: ...
    @property
    def application_context_name(self) -> Application_context_name: ...
    @application_context_name.setter
    def application_context_name(
        self, value: Application_context_name | str
    ) -> None: ...
    ...
    def called_AP_invocation_identifier(
        self, value: AP_invocation_identifier | int | None
    ) -> None: ...
    @property
    def called_AE_invocation_identifier(self) -> AE_invocation_identifier | None: ...
    @called_AE_invocation_identifier.setter
    def called_AE_invocation_identifier(
        self, value: AE_invocation_identifier | int | None
    ) -> None: ...
    ...
    def application_context_name_list(
        self, value: Application_context_name_list | list | None
    ) -> None: ...
    @property
    def implementation_information(self) -> Implementation_data | None: ...
    @implementation_information.setter
    def implementation_information(
        self, value: Implementation_data | str | None
    ) -> None: ...
    @property
    def user_information(self) -> Association_information | None: ...
    @user_information.setter
    def user_information(
        self, value: Association_information | list | None
    ) -> None: ...
    def __init__(
        self,
        /,
...
class AARE_apdu(_Asn1Type):  # SEQUENCE
    ...
    result_source_diagnostic: Associate_source_diagnostic | None
    responding_AP_title: AP_title | None
    responding_AE_qualifier: AE_qualifier | None
    @property
    def responding_AP_invocation_identifier(
        self,
    ...
    @property
    def responding_AE_invocation_identifier(
        self,
    ...
    def responder_acse_requirements(
        self, value: ACSE_requirements | EXT_bitarray | int | bytes | None
    ) -> None: ...
    @property
    def mechanism_name(self) -> Mechanism_name | None: ...
...
class Application_context_name_list(_Asn1Type):
    def __init__(
        self, values: EXT_Iterable[Application_context_name] | None = ...
    ) -> None: ...
...
class Authentication_value(_Asn1Type):  # CHOICE
    ...
    @bitstring.setter
    def bitstring(
        self, value: bitstring_TYPE | EXT_bitarray | bytes | None
    ) -> None: ...
...
class MMSpdu(_Asn1Type):  # CHOICE
    ...
    def conclude_RequestPDU(self, value: Conclude_RequestPDU | None) -> None: ...
    @property
    def conclude_ResponsePDU(self) -> Conclude_ResponsePDU | None: ...
    @conclude_ResponsePDU.setter
    def conclude_ResponsePDU(self, value: Conclude_ResponsePDU | None) -> None: ...
...
class Confirmed_RequestPDU(_Asn1Type):  # SEQUENCE
    ...
    service: ConfirmedServiceRequest | None
...
class ConfirmedServiceRequest(_Asn1Type):  # CHOICE
    ...
    @identify.setter
    def identify(self, value: Identify_Request | None) -> None: ...
...
class AdditionalService_Request(_Asn1Type):  # CHOICE
    ...
    @vMDStop.setter
    def vMDStop(self, value: VMDStop_Request | None) -> None: ...
    @property
...
class Request_Detail(_Asn1Type):  # CHOICE
    ...
    def createProgramInvocation(
        self, value: CS_CreateProgramInvocation_Request | int | None
    ) -> None: ...
...
class Unconfirmed_PDU(_Asn1Type):  # SEQUENCE
    service: UnconfirmedService | None
...
class Confirmed_ResponsePDU(_Asn1Type):  # SEQUENCE
    ...
    @invokeID.setter
    def invokeID(self, value: Unsigned32 | int) -> None: ...
    service: ConfirmedServiceResponse | None
...
class ConfirmedServiceResponse(_Asn1Type):  # CHOICE
    ...
    @rename.setter
    def rename(self, value: Rename_Response | None) -> None: ...
    ...
    def defineNamedVariable(
        self, value: DefineNamedVariable_Response | None
    ) -> None: ...
    @property
    def defineScatteredAccess(self) -> DefineScatteredAccess_Response | None: ...
    @defineScatteredAccess.setter
    def defineScatteredAccess(
        self, value: DefineScatteredAccess_Response | None
    ) -> None: ...
    ...
    def defineNamedVariableList(
        self, value: DefineNamedVariableList_Response | None
    ) -> None: ...
    ...
    def defineNamedType(self, value: DefineNamedType_Response | None) -> None: ...
    ...
    def initiateDownloadSequence(
        self, value: InitiateDownloadSequence_Response | None
    ) -> None: ...
    downloadSegment: DownloadSegment_Response | None
    @property
    def terminateDownloadSequence(
        self,
    ) -> TerminateDownloadSequence_Response | None: ...
    @terminateDownloadSequence.setter
    def terminateDownloadSequence(
        self, value: TerminateDownloadSequence_Response | None
    ) -> None: ...
    ...
    def terminateUploadSequence(
        self, value: TerminateUploadSequence_Response | None
    ) -> None: ...
    @property
    def requestDomainDownload(self) -> RequestDomainDownload_Response | None: ...
    @requestDomainDownload.setter
    def requestDomainDownload(
        self, value: RequestDomainDownload_Response | None
    ) -> None: ...
    @property
    def requestDomainUpload(self) -> RequestDomainUpload_Response | None: ...
    @requestDomainUpload.setter
    def requestDomainUpload(
        self, value: RequestDomainUpload_Response | None
    ) -> None: ...
    @property
    def loadDomainContent(self) -> LoadDomainContent_Response | None: ...
    @loadDomainContent.setter
    def loadDomainContent(self, value: LoadDomainContent_Response | None) -> None: ...
    @property
    def storeDomainContent(self) -> StoreDomainContent_Response | None: ...
    @storeDomainContent.setter
    def storeDomainContent(self, value: StoreDomainContent_Response | None) -> None: ...
    @property
    def deleteDomain(self) -> DeleteDomain_Response | None: ...
    @deleteDomain.setter
    def deleteDomain(self, value: DeleteDomain_Response | None) -> None: ...
    ...
    @property
    def alterEventConditionMonitoring(
        self,
    ) -> AlterEventConditionMonitoring_Response | None: ...
    @alterEventConditionMonitoring.setter
    def alterEventConditionMonitoring(
        self, value: AlterEventConditionMonitoring_Response | None
    ) -> None: ...
    @property
    def triggerEvent(self) -> TriggerEvent_Response | None: ...
    @triggerEvent.setter
    def triggerEvent(self, value: TriggerEvent_Response | None) -> None: ...
    @property
    def defineEventAction(self) -> DefineEventAction_Response | None: ...
    @defineEventAction.setter
    def defineEventAction(self, value: DefineEventAction_Response | None) -> None: ...
    ...
    def defineEventEnrollment(
        self, value: DefineEventEnrollment_Response | None
    ) -> None: ...
    ...
    @property
    def acknowledgeEventNotification(
        self,
    ) -> AcknowledgeEventNotification_Response | None: ...
    @acknowledgeEventNotification.setter
    def acknowledgeEventNotification(
        self, value: AcknowledgeEventNotification_Response | None
    ) -> None: ...
    ...
    @writeJournal.setter
    def writeJournal(self, value: WriteJournal_Response | None) -> None: ...
    ...
    def createJournal(self, value: CreateJournal_Response | None) -> None: ...
    @property
    def deleteJournal(self) -> DeleteJournal_Response | None: ...
    @deleteJournal.setter
    def deleteJournal(self, value: DeleteJournal_Response | None) -> None: ...
    ...
    @fileClose.setter
    def fileClose(self, value: FileClose_Response | None) -> None: ...
    @property
    def fileRename(self) -> FileRename_Response | None: ...
    @fileRename.setter
    def fileRename(self, value: FileRename_Response | None) -> None: ...
    @property
    def fileDelete(self) -> FileDelete_Response | None: ...
    @fileDelete.setter
    def fileDelete(self, value: FileDelete_Response | None) -> None: ...
    ...
    def defineAccessControlList(
        self, value: DefineAccessControlList_Response | None
    ) -> None: ...
    ...
    def deleteAccessControlList(
        self, value: DeleteAccessControlList_Response | None
    ) -> None: ...
...
class AdditionalService_Response(_Asn1Type):  # CHOICE
    ...
    @startUC.setter
    def startUC(self, value: StartUnitControl_Response | None) -> None: ...
    @property
    def stopUC(self) -> StopUnitControl_Response | None: ...
    @stopUC.setter
    def stopUC(self, value: StopUnitControl_Response | None) -> None: ...
    @property
    def createUC(self) -> CreateUnitControl_Response | None: ...
    @createUC.setter
    def createUC(self, value: CreateUnitControl_Response | None) -> None: ...
    @property
    def addToUC(self) -> AddToUnitControl_Response | None: ...
    @addToUC.setter
    def addToUC(self, value: AddToUnitControl_Response | None) -> None: ...
    @property
    def removeFromUC(self) -> RemoveFromUnitControl_Response | None: ...
    @removeFromUC.setter
    def removeFromUC(self, value: RemoveFromUnitControl_Response | None) -> None: ...
    ...
    def loadUCFromFile(
        self, value: LoadUnitControlFromFile_Response | None
    ) -> None: ...
    @property
    def storeUCToFile(self) -> StoreUnitControlToFile_Response | None: ...
    @storeUCToFile.setter
    def storeUCToFile(self, value: StoreUnitControlToFile_Response | None) -> None: ...
    @property
    def deleteUC(self) -> DeleteUnitControl_Response | None: ...
    @deleteUC.setter
    def deleteUC(self, value: DeleteUnitControl_Response | None) -> None: ...
    @property
    def defineECL(self) -> DefineEventConditionList_Response | None: ...
    @defineECL.setter
    def defineECL(self, value: DefineEventConditionList_Response | None) -> None: ...
    @property
    def deleteECL(self) -> DeleteEventConditionList_Response | None: ...
    @deleteECL.setter
    def deleteECL(self, value: DeleteEventConditionList_Response | None) -> None: ...
    @property
    def addECLReference(self) -> AddEventConditionListReference_Response | None: ...
    @addECLReference.setter
    def addECLReference(
        self, value: AddEventConditionListReference_Response | None
    ) -> None: ...
    @property
    def removeECLReference(
        self,
    ) -> RemoveEventConditionListReference_Response | None: ...
    @removeECLReference.setter
    def removeECLReference(
        self, value: RemoveEventConditionListReference_Response | None
    ) -> None: ...
    ...
    @property
    def alterECLMonitoring(
        self,
    ) -> AlterEventConditionListMonitoring_Response | None: ...
    @alterECLMonitoring.setter
    def alterECLMonitoring(
        self, value: AlterEventConditionListMonitoring_Response | None
    ) -> None: ...
    def __init__(
        self,
        /,
...
class Initiate_RequestPDU(_Asn1Type):  # SEQUENCE
    class initRequestDetail_TYPE(_Asn1Type):  # SEQUENCE
        ...
        def proposedParameterCBB(
            self, value: ParameterSupportOptions | EXT_bitarray | int | bytes
        ) -> None: ...
        @property
        def servicesSupportedCalling(self) -> ServiceSupportOptions: ...
        @servicesSupportedCalling.setter
        def servicesSupportedCalling(
            self, value: ServiceSupportOptions | EXT_bitarray | int | bytes
        ) -> None: ...
        @property
        def additionalSupportedCalling(self) -> AdditionalSupportOptions | None: ...
        @additionalSupportedCalling.setter
        def additionalSupportedCalling(
            self, value: AdditionalSupportOptions | EXT_bitarray | int | bytes | None
        ) -> None: ...
        @property
        def additionalCbbSupportedCalling(self) -> AdditionalCBBOptions | None: ...
        @additionalCbbSupportedCalling.setter
        def additionalCbbSupportedCalling(
            self, value: AdditionalCBBOptions | EXT_bitarray | int | bytes | None
        ) -> None: ...
    ...
    def proposedDataStructureNestingLevel(
        self, value: Integer8 | int | None
    ) -> None: ...
    def __init__(
        self,
        /,
...
class Initiate_ResponsePDU(_Asn1Type):  # SEQUENCE
    ...
    def negotiatedDataStructureNestingLevel(
        self, value: Integer8 | int | None
    ) -> None: ...
    def __init__(
        self,
        ...
        class listOfObjects_TYPE(_Asn1Type):  # SEQUENCE
            class objectScope_TYPE(_Asn1Type):  # CHOICE
                ...
                class specific_TYPE(_Asn1Type):
                    def __init__(
                        self, values: EXT_Iterable[ObjectName] | None = ...
                    ) -> None: ...
                    def __getitem__(self, index: int) -> ObjectName: ...
                    def __setitem__(self, index: int, value: ObjectName) -> None: ...
                    def add(self, value: ObjectName) -> None: ...
...
class StatusResponse(_Asn1Type):  # SEQUENCE
    ...
    @localDetail.setter
    def localDetail(
        self, value: localDetail_TYPE | EXT_bitarray | bytes | None
    ) -> None: ...
    def __init__(
        self,
        /,
...
class CS_Status_Response(_Asn1Type):  # CHOICE
    ...
    class fullResponse_TYPE(_Asn1Type):  # SEQUENCE
        ...
        def extendedStatus(
            self, value: ExtendedStatus | EXT_bitarray | int | bytes
        ) -> None: ...
        @property
        def extendedStatusMask(self) -> ExtendedStatus | None: ...
        @extendedStatusMask.setter
        def extendedStatusMask(
            self, value: ExtendedStatus | EXT_bitarray | int | bytes | None
        ) -> None: ...
        def __init__(
            self,
            /,
...
class RequestDomainDownload_Request(_Asn1Type):  # SEQUENCE
    ...
    @fileName.setter
    def fileName(self, value: FileName | list | None) -> None: ...
    def __init__(
        self,
        /,
        *,
    ...
    class control_TYPE(_Asn1Type):  # CHOICE
        ...
        class controlling_TYPE(_Asn1Type):  # SEQUENCE
            class controlledPI_TYPE(_Asn1Type):
                def __init__(
                    self, values: EXT_Iterable[Identifier] | None = ...
                ) -> None: ...
                def __getitem__(self, index: int) -> Identifier: ...
                def __setitem__(self, index: int, value: Identifier) -> None: ...
                def add(self, value: Identifier) -> None: ...
...
class ControlElement(_Asn1Type):  # CHOICE
    ...
    class beginDomainDef_TYPE(_Asn1Type):  # SEQUENCE
        class capabilities_TYPE(_Asn1Type):
            def __init__(
                self, values: EXT_Iterable[MMSString] | None = ...
            ) -> None: ...
            def __getitem__(self, index: int) -> MMSString: ...
            def __setitem__(self, index: int, value: MMSString) -> None: ...
            def add(self, value: MMSString) -> None: ...
...
class UnitControlLoadSegment_Response(_Asn1Type):  # SEQUENCE
    class controlElements_TYPE(_Asn1Type):
        def __init__(
            self, values: EXT_Iterable[ControlElement] | None = ...
        ) -> None: ...
...
class Data(_Asn1Type):  # CHOICE
    ...
    @bit_string.setter
    def bit_string(
        self, value: bit_string_TYPE | EXT_bitarray | bytes | None
    ) -> None: ...
    integer: int | None
    unsigned: int | None
    @property
    ...
    @booleanArray.setter
    def booleanArray(
        self, value: booleanArray_TYPE | EXT_bitarray | bytes | None
    ) -> None: ...
    objId: str | None
    @property
...
class VariableSpecification(_Asn1Type):  # CHOICE
    ...
    def scatteredAccessDescription(
        self, value: ScatteredAccessDescription | list | None
    ) -> None: ...
    invalidated: None
    def __init__(
        self,
...
class ExchangeData_Request(_Asn1Type):  # SEQUENCE
    ...
    dataExchangeName: ObjectName | None
    def __init__(
        self,
        /,
        *,
...
class GetDataExchangeAttributes_Response(_Asn1Type):  # SEQUENCE
    class listOfRequestTypeDescriptions_TYPE(_Asn1Type):
        def __init__(
            self, values: EXT_Iterable[TypeDescription] | None = ...
        ) -> None: ...
...
class ReportSemaphoreStatus_Response(_Asn1Type):  # SEQUENCE
    ...
    class c_l_a_s_s__VALUES(EXT_IntEnum):
        V_token = 0
        V_pool = 1

    c_l_a_s_s_: c_l_a_s_s__VALUES
    @property
    def numberOfTokens(self) -> Unsigned16: ...
    @numberOfTokens.setter
    def numberOfTokens(self, value: Unsigned16 | int) -> None: ...
...
class ReportSemaphoreEntryStatus_Response(_Asn1Type):  # SEQUENCE
    class listOfSemaphoreEntry_TYPE(_Asn1Type):
        def __init__(
            self, values: EXT_Iterable[SemaphoreEntry] | None = ...
        ) -> None: ...
...
class SemaphoreEntry(_Asn1Type):  # SEQUENCE
    ...
    applicationReference: ApplicationReference | None
    @property
    def namedToken(self) -> Identifier | None: ...
    @namedToken.setter
    def namedToken(self, value: Identifier | str | None) -> None: ...
...
class EventNotification(_Asn1Type):  # SEQUENCE
    class actionResult_TYPE(_Asn1Type):  # SEQUENCE
        class successOrFailure_TYPE(_Asn1Type):  # CHOICE
            ...
            class success_TYPE(_Asn1Type):  # SEQUENCE
                confirmedServiceResponse: ConfirmedServiceResponse | None
    ...
    eventEnrollmentName: ObjectName | None
    eventConditionName: ObjectName | None
    @property
...
class AcknowledgeEventNotification_Request(_Asn1Type):  # SEQUENCE
    ...
    timeOfAcknowledgedTransition: EventTime | None
    def __init__(
        self,
        /,
        *,
...
class GetAlarmEnrollmentSummary_Response(_Asn1Type):  # SEQUENCE
    class listOfAlarmEnrollmentSummary_TYPE(_Asn1Type):
        def __init__(
            self, values: EXT_Iterable[AlarmEnrollmentSummary] | None = ...
        ) -> None: ...
...
class AttachToEventCondition(_Asn1Type):  # SEQUENCE
    ...
    def causingTransitions(
        self, value: Transitions | EXT_bitarray | int | bytes
    ) -> None: ...
    @property
    def acceptableDelay(self) -> Unsigned32 | None: ...
    @acceptableDelay.setter
...
class DefineEventCondition_Request(_Asn1Type):  # SEQUENCE
    eventConditionName: ObjectName | None
    @property
    def c_l_a_s_s_(self) -> EC_Class: ...
    @c_l_a_s_s_.setter
    def c_l_a_s_s_(self, value: EC_Class | int) -> None: ...
    @property
    def priority(self) -> Priority | None: ...
    @priority.setter
    def priority(self, value: Priority | int | None) -> None: ...
...
class AlterEventEnrollment_Request(_Asn1Type):  # SEQUENCE
    ...
    @eventConditionTransitions.setter
    def eventConditionTransitions(
        self, value: Transitions | EXT_bitarray | int | bytes | None
    ) -> None: ...
    @property
    def alarmAcknowledgmentRule(self) -> AlarmAckRule | None: ...
    @alarmAcknowledgmentRule.setter
...
class DefineEventConditionList_Request(_Asn1Type):  # SEQUENCE
    ...
    eventConditionListName: ObjectName | None
    def __init__(
        self,
        /,
        *,
...
class ReportEventConditionListStatus_Response(_Asn1Type):  # SEQUENCE
    class listOfEventConditionStatus_TYPE(_Asn1Type):
        def __init__(
            self, values: EXT_Iterable[EventConditionStatus] | None = ...
        ) -> None: ...
...
class JournalEntry(_Asn1Type):  # SEQUENCE
    ...
    originatingApplication: ApplicationReference | None
    entryContent: EntryContent | None
    def __init__(
        self,
        /,
        *,
...
class EntryContent(_Asn1Type):  # SEQUENCE
    class entryForm_TYPE(_Asn1Type):  # CHOICE
        ...
        class data_TYPE(_Asn1Type):  # SEQUENCE
            ...
            class listOfVariables_TYPE(_Asn1Type):
                def __init__(
                    self, values: EXT_Iterable[Journal_Variable] | None = ...
                ) -> None: ...
...
class ObtainFile_Request(_Asn1Type):  # SEQUENCE
    ...
    @property
    def sourceFile(self) -> FileName | None: ...
    @sourceFile.setter
    def sourceFile(self, value: FileName | list | None) -> None: ...
    @property
    def destinationFile(self) -> FileName | None: ...
    @destinationFile.setter
    def destinationFile(self, value: FileName | list | None) -> None: ...
    def __init__(
        self,
        /,
        *,
...
class FileRename_Request(_Asn1Type):  # SEQUENCE
    @property
    def currentFileName(self) -> FileName | None: ...
    @currentFileName.setter
    def currentFileName(self, value: FileName | list | None) -> None: ...
    @property
    def newFileName(self) -> FileName | None: ...
    @newFileName.setter
    def newFileName(self, value: FileName | list | None) -> None: ...
    def __init__(
        self,
        /,
        *,
...
class FileDirectory_Response(_Asn1Type):  # SEQUENCE
    class listOfDirectoryEntry_TYPE(_Asn1Type):
        def __init__(
            self, values: EXT_Iterable[DirectoryEntry] | None = ...
        ) -> None: ...
...
class DefineScatteredAccess_Request(_Asn1Type):  # SEQUENCE
    scatteredAccessName: ObjectName | None
    @property
    def scatteredAccessDescription(self) -> ScatteredAccessDescription | None: ...
    @scatteredAccessDescription.setter
    def scatteredAccessDescription(
...
class AccessCondition(_Asn1Type):  # CHOICE
    ...
    class joint_TYPE(_Asn1Type):
        def __init__(
            self, values: EXT_Iterable[AccessCondition] | None = ...
        ) -> None: ...
...
class TypeDescription(_Asn1Type):  # CHOICE
    ...
    class structure_TYPE(_Asn1Type):  # SEQUENCE
        class components_TYPE(_Asn1Type):
            ...
            def __init__(
                self, values: EXT_Iterable[Member_TYPE] | None = ...
            ) -> None: ...
            def __getitem__(self, index: int) -> Member_TYPE: ...
            def __setitem__(self, index: int, value: Member_TYPE) -> None: ...
            def add(self, value: Member_TYPE) -> None: ...
...
class EXTERNAL(_Asn1Type):  # SEQUENCE
    class encoding_TYPE(_Asn1Type):  # CHOICE
        ...
        @arbitrary.setter
        def arbitrary(
            self, value: arbitrary_TYPE | EXT_bitarray | bytes | None
        ) -> None: ...
        def __init__(
            self,
            /,
