...
extern asn_TYPE_descriptor_t asn_DEF_variableDescription __attribute__((weak, alias("asn_DEF_variableDescription_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_variableDescription_4;
static asn_TYPE_descriptor_t asn_DEF_variableDescription;
__attribute__((constructor)) static void asn_DEF_variableDescription_4_alias_init(void) {
	asn_DEF_variableDescription = asn_DEF_variableDescription_4;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
static asn_TYPE_member_t asn_MBR_VariableSpecification__variableDescription_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_variableDescription_4 = {
	...
	asn_MBR_VariableSpecification__variableDescription_4,
	2,	/* Elements count */
	&asn_SPC_variableDescription_specs_4	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_VariableSpecification_1[] = {
	{ ATF_POINTER, 0, offsetof(struct VariableSpecification, choice.name),
	...
	{ ATF_POINTER, 0, offsetof(struct VariableSpecification, choice.address),
