...
asn_TYPE_member_t asn_MBR_EN_Additional_Detail_1[] = {
...
static const ber_tlv_tag_t asn_DEF_EN_Additional_Detail_tags_1[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EN_Additional_Detail_tag2el_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_EN_Additional_Detail_specs_1 = {
