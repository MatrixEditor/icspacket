...
extern asn_TYPE_descriptor_t asn_DEF_monitoredVariable __attribute__((weak, alias("asn_DEF_monitoredVariable_7")));
#else
static asn_TYPE_descriptor_t asn_DEF_monitoredVariable_7;
static asn_TYPE_descriptor_t asn_DEF_monitoredVariable;
__attribute__((constructor)) static void asn_DEF_monitoredVariable_7_alias_init(void) {
	asn_DEF_monitoredVariable = asn_DEF_monitoredVariable_7;
}
#endif
...
static asn_TYPE_member_t asn_MBR_GetEventConditionAttributes_Response__monitoredVariable_7[] = {
...
asn_TYPE_descriptor_t asn_DEF_monitoredVariable_7 = {
	...
	asn_MBR_GetEventConditionAttributes_Response__monitoredVariable_7,
	2,	/* Elements count */
