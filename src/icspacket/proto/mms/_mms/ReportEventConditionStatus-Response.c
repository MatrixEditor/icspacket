...
asn_TYPE_member_t asn_MBR_ReportEventConditionStatus_Response_1[] = {
...
static const int asn_MAP_ReportEventConditionStatus_Response_oms_1[] = { 2, 3, 4 };
static const ber_tlv_tag_t asn_DEF_ReportEventConditionStatus_Response_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ReportEventConditionStatus_Response_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* currentState */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* numberOfEventEnrollments */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* enabled */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* timeOfLastTransitionToActive */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* timeOfLastTransitionToIdle */
};
asn_SEQUENCE_specifics_t asn_SPC_ReportEventConditionStatus_Response_specs_1 = {
	...
	asn_MAP_ReportEventConditionStatus_Response_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
