...
static asn_TYPE_member_t asn_MBR_CS_AlterEventConditionMonitoring_Request__changeDisplay_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_changeDisplay_2 = {
	...
	asn_MBR_CS_AlterEventConditionMonitoring_Request__changeDisplay_2,
	3,	/* Elements count */
