...
extern asn_TYPE_descriptor_t asn_DEF_domain_specific __attribute__((weak, alias("asn_DEF_domain_specific_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_domain_specific_3;
static asn_TYPE_descriptor_t asn_DEF_domain_specific;
__attribute__((constructor)) static void asn_DEF_domain_specific_3_alias_init(void) {
	asn_DEF_domain_specific = asn_DEF_domain_specific_3;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
static asn_TYPE_member_t asn_MBR_ObjectName__domain_specific_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_domain_specific_3 = {
	...
	asn_MBR_ObjectName__domain_specific_3,
	2,	/* Elements count */
