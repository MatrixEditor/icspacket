...
extern asn_TYPE_descriptor_t asn_DEF_objectScope __attribute__((weak, alias("asn_DEF_objectScope_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_objectScope_3;
static asn_TYPE_descriptor_t asn_DEF_objectScope;
__attribute__((constructor)) static void asn_DEF_objectScope_3_alias_init(void) {
	asn_DEF_objectScope = asn_DEF_objectScope_3;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
static asn_TYPE_member_t asn_MBR_GetNameList_Request__objectScope_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_objectScope_3 = {
	...
	asn_MBR_GetNameList_Request__objectScope_3,
	3,	/* Elements count */
	&asn_SPC_objectScope_specs_3	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_GetNameList_Request_1[] = {
	{ ATF_POINTER, 0, offsetof(struct GetNameList_Request, objectClass),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
