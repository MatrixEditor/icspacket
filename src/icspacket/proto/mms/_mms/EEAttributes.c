...
extern asn_TYPE_descriptor_t asn_DEF_eventConditionName __attribute__((weak, alias("asn_DEF_eventConditionName_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_eventConditionName_3;
static asn_TYPE_descriptor_t asn_DEF_eventConditionName;
__attribute__((constructor)) static void asn_DEF_eventConditionName_3_alias_init(void) {
	asn_DEF_eventConditionName = asn_DEF_eventConditionName_3;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_eventActionName __attribute__((weak, alias("asn_DEF_eventActionName_6")));
#else
static asn_TYPE_descriptor_t asn_DEF_eventActionName_6;
static asn_TYPE_descriptor_t asn_DEF_eventActionName;
__attribute__((constructor)) static void asn_DEF_eventActionName_6_alias_init(void) {
	asn_DEF_eventActionName = asn_DEF_eventActionName_6;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_displayEnhancement __attribute__((weak, alias("asn_DEF_displayEnhancement_15")));
#else
static asn_TYPE_descriptor_t asn_DEF_displayEnhancement_15;
static asn_TYPE_descriptor_t asn_DEF_displayEnhancement;
__attribute__((constructor)) static void asn_DEF_displayEnhancement_15_alias_init(void) {
	asn_DEF_displayEnhancement = asn_DEF_displayEnhancement_15;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
static asn_TYPE_member_t asn_MBR_EEAttributes__eventConditionName_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_eventConditionName_3 = {
	...
	asn_MBR_EEAttributes__eventConditionName_3,
	2,	/* Elements count */
	&asn_SPC_eventConditionName_specs_3	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_EEAttributes__eventActionName_6[] = {
...
asn_TYPE_descriptor_t asn_DEF_eventActionName_6 = {
	...
	asn_MBR_EEAttributes__eventActionName_6,
	2,	/* Elements count */
...
static asn_TYPE_member_t asn_MBR_EEAttributes__displayEnhancement_15[] = {
...
asn_TYPE_descriptor_t asn_DEF_displayEnhancement_15 = {
	...
	asn_MBR_EEAttributes__displayEnhancement_15,
	3,	/* Elements count */
	&asn_SPC_displayEnhancement_specs_15	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_EEAttributes_1[] = {
	{ ATF_POINTER, 0, offsetof(struct EEAttributes, eventEnrollmentName),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_ObjectName,
		0,
