...
typedef enum ServiceSupportOptions {
	...
	ServiceSupportOptions_getDataExchangeAttributes	= 85,
	ServiceSupportOptions_exchangeData	= 86,
	ServiceSupportOptions_defineAccessControlList	= 87,
	ServiceSupportOptions_getAccessControlListAttributes	= 88,
	ServiceSupportOptions_reportAccessControlledObjects	= 89,
	ServiceSupportOptions_deleteAccessControlList	= 90,
	ServiceSupportOptions_alterAccessControl	= 91,
	ServiceSupportOptions_reconfigureProgramInvocation	= 92
...
/* Implementation */
extern asn_jer_constraints_t asn_JER_type_ServiceSupportOptions_constr_1;
...
jer_type_encoder_f ServiceSupportOptions_encode_jer;
