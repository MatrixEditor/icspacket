...
extern asn_TYPE_descriptor_t asn_DEF_user __attribute__((weak, alias("asn_DEF_user_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_user_4;
static asn_TYPE_descriptor_t asn_DEF_user;
__attribute__((constructor)) static void asn_DEF_user_4_alias_init(void) {
	asn_DEF_user = asn_DEF_user_4;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_joint __attribute__((weak, alias("asn_DEF_joint_8")));
#else
static asn_TYPE_descriptor_t asn_DEF_joint_8;
static asn_TYPE_descriptor_t asn_DEF_joint;
__attribute__((constructor)) static void asn_DEF_joint_8_alias_init(void) {
	asn_DEF_joint = asn_DEF_joint_8;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_alternate __attribute__((weak, alias("asn_DEF_alternate_10")));
#else
static asn_TYPE_descriptor_t asn_DEF_alternate_10;
static asn_TYPE_descriptor_t asn_DEF_alternate;
__attribute__((constructor)) static void asn_DEF_alternate_10_alias_init(void) {
	asn_DEF_alternate = asn_DEF_alternate_10;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
static asn_TYPE_member_t asn_MBR_AccessCondition__user_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_user_4 = {
	...
	asn_MBR_AccessCondition__user_4,
	2,	/* Elements count */
	&asn_SPC_user_specs_4	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_AccessCondition__joint_8[] = {
	{ ATF_POINTER, 0, 0,
...
asn_TYPE_descriptor_t asn_DEF_joint_8 = {
	...
	asn_MBR_AccessCondition__joint_8,
	1,	/* Single element */
	&asn_SPC_joint_specs_8	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_AccessCondition__alternate_10[] = {
	{ ATF_POINTER, 0, 0,
		-1 /* Ambiguous tag (CHOICE?) */,
		0,
		&asn_DEF_AccessCondition,
...
asn_TYPE_descriptor_t asn_DEF_alternate_10 = {
	...
	asn_MBR_AccessCondition__alternate_10,
	1,	/* Single element */
...
asn_TYPE_member_t asn_MBR_AccessCondition_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct AccessCondition, choice.password),
