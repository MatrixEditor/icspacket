...
asn_TYPE_member_t asn_MBR_UploadSegment_Response_1[] = {
	{ ATF_POINTER, 0, offsetof(struct UploadSegment_Response, loadData),
...
static const int asn_MAP_UploadSegment_Response_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_UploadSegment_Response_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UploadSegment_Response_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_UploadSegment_Response_specs_1 = {
	...
	asn_MAP_UploadSegment_Response_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
