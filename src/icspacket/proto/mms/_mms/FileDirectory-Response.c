...
extern asn_TYPE_descriptor_t asn_DEF_listOfDirectoryEntry __attribute__((weak, alias("asn_DEF_listOfDirectoryEntry_2")));
#else
static asn_TYPE_descriptor_t asn_DEF_listOfDirectoryEntry_2;
static asn_TYPE_descriptor_t asn_DEF_listOfDirectoryEntry;
__attribute__((constructor)) static void asn_DEF_listOfDirectoryEntry_2_alias_init(void) {
	asn_DEF_listOfDirectoryEntry = asn_DEF_listOfDirectoryEntry_2;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
static asn_TYPE_member_t asn_MBR_FileDirectory_Response__listOfDirectoryEntry_2[] = {
	{ ATF_POINTER, 0, 0,
...
asn_TYPE_descriptor_t asn_DEF_listOfDirectoryEntry_2 = {
	...
	asn_MBR_FileDirectory_Response__listOfDirectoryEntry_2,
	1,	/* Single element */
