...
#include <Address.h>
asn_TYPE_member_t asn_MBR_Address_1[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_Address_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* numericAddress */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* symbolicAddress */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* unconstrainedAddress */
};
asn_CHOICE_specifics_t asn_SPC_Address_specs_1 = {
