...
static const asn_INTEGER_enum_map_t *ENUMERATED_jer_map_enum2value(
...
static enum jer_pbd_rval ENUMERATED__jer_body_decode(
...
asn_dec_rval_t ENUMERATED_decode_jer(const asn_codec_ctx_t *opt_codec_ctx,
